...
if (temperature >= 80 && rain){
  console.log("One should wear a t-shirt and take an umberlla")
}else if (temperature >=60 && rain){
  console.log("One should wear a rain-jacket")
}else if (temperature <=59 && rain){
  console.log("One should wear a jacket and pack an umbrella")
}else if (temperature >=80 && !rain){
  console.log("one should wear a tank top")
}else if (temperature >=60 && !rain){
  console.log("a light jacket")
}else{
  console.log("It will be really cold outside")
}
...
} console.log("You passed the score!")
